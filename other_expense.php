...
if(isset($_SESSION['user']))
{
    ...
    $sql="SELECT * FROM others WHERE status=0";
    ...
    <div class="container-fluid">
      <div class="row">
           ...
           <li><a href="loan.php">വായ്പ എടുക്കുക </a></li>
            ...
            <li><a href="interest_pay.php">വായ്പ പലിശ അടയ്ക്കുക </a></li>
             <li ><a href="interest_report.php">വാര്‍ഷിക പലിശ റിപ്പോര്‍ട്ട് </a></li>
              ...
              <li class="active"><a href="other_expense.php"> മറ്റു ചിലവുകള്‍   </a> ‍</li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="background-image:url('images/1.jpg') ;background-repeat: no-repeat; background-position: center;background-size: cover;">
            <center>  <b> <h1  style="color:green;font-weight: 10000; text-shadow: 2px 2px green;">മറ്റു ചിലവുകള്‍‍</h1></b></center>
                     
          
            <form class="form-signin" role="form" action="other_expense.php" method="post">  
                <div class="form-group">
                <span class="label label-primary">ചെലവിനം  :</span>
                <input type="text" class="form-control" placeholder="ചെലവ്  കാരണം " name="src" required><br>
            </div>
                <div class="form-group">
                <span class="label label-primary">ചെലവ് തുക  :</span>
                <input type="number" class="form-control" placeholder="ചെലവ് തുക " name="amount" required><br>
        ...
        <div class='table-responsive' >
            <table class='table table-bordered' id='ttr' style='background-color:white; -webkit-column-width: 100px;-moz-column-width: 100px;column-width: 100px;'>
                ...
                <tr><th class="col-md-4">കാരണം </td><td class="col-md-4">ചെലവ് തുക  </td><td class="col-md-2"> തീയതി</td></tr>
...
if(isset($_POST['submit']))
{
    ...
    $amount=$_POST['amount'];
    $dat=date('Y-m-d');
    $sql="INSERT INTO others (reason,amount,status,date) VALUES ('$resr','$amount',0,'$dat')";
...
function s() {
	...
	swal({ title:"   കൈരളി സ്വാശ്രയ സംഘം",text:" "+a+"ചെലവ്  രേഖപ്പെടുത്തിയിരിക്കുന്നു. ", type:"success"},function(){
    window.location.href = 'other_expense.php';});
}
</script>